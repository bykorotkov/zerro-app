                        ...
                        {data.items && data.items.length ? (
                            <div className={classes.Previews}>
                                {data.items.map((item, index) => (
                                    <div
                                        className={cn(classes.Preview, activeTeacherIndex === index && classes.ActivePreview)}
                                        key={item.id}
                                        onClick={() => changeTeacher(index)}
                                    >
                                        <LazyLoadImage
                                            src={item.preview}
                                            alt=""
                            ...
                            >
                                ...
                                >
                                    <LazyLoadImage
                                        ...
                                        src={data.items[activeTeacherIndex].image}
                                        alt=""
                                    />
                                    ...
                                    <div className={classes.Inner}>
                                        <div className={classes.CardTop}>
                                            <div
                                                ...
                                                dangerouslySetInnerHTML={{ __html: data.items[activeTeacherIndex].name }}
                                            />
                                            <div
                                                className={classes.Text}
                                                dangerouslySetInnerHTML={{ __html: data.items[activeTeacherIndex].text }}
                                            />
                                        </div>
